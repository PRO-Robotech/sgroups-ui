...
describe('VerboseRulePanel', () => {
  ...
  it('renders rule details and endpoint trees', () => {
    ...
    expect(screen.getByText('ag-a (tenant-a)')).toBeInTheDocument()
    expect(screen.getByText('svc-a (tenant-a)')).toBeInTheDocument()
    expect(screen.getByText('Address Group A (tenant-a)')).toBeInTheDocument()
    expect(screen.getByText('Service A (tenant-a)')).toBeInTheDocument()
  })
})
