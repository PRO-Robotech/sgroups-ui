...
type TEditSgFqdnPopoverProps = {
  values: TFormSgFqdnRule
  hide: () => void
  remove: () => void
  edit: (values: TFormSgFqdnRule) => void
  isDisabled?: boolean
}

export const EditSgFqdnPopover: FC<TEditSgFqdnPopoverProps> = ({ values, hide, remove, edit, isDisabled }) => {
  ...
  return (
    <Form
      form={addForm}
      onFinish={(values: Omit<TFormSgFqdnRule, 'prioritySome'> & { prioritySome?: string }) =>
        edit({
          ...values,
