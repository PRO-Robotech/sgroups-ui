...
type TEditSgCidrIcmpPopoverProps = {
  values: TFormSgCidrIcmpRule
  hide: () => void
  remove: () => void
  edit: (values: TFormSgCidrIcmpRule) => void
  isDisabled?: boolean
}

export const EditSgCidrIcmpPopover: FC<TEditSgCidrIcmpPopoverProps> = ({ values, hide, remove, edit, isDisabled }) => {
  ...
  return (
    <Form
      form={addForm}
      onFinish={(values: Omit<TFormSgCidrIcmpRule, 'prioritySome'> & { prioritySome?: string }) =>
        edit({
          ...values,
