...
const SplitLayout = styled.div<{
  ...
  min-height: 0;
  overflow: hidden;
  border: 1px solid var(--rules-border-color, #d9d9d9);
  border-radius: 12px;
  background: var(--rules-bg-color, white);
...
const TablePane = styled.div`
  ...
  .ant-table-tbody > .rule-row-selected > td {
    background: var(--rules-row-selected-bg, #e6f4ff);
  }

  .ant-table-tbody > .rule-row-selected:hover > td {
    background: var(--rules-row-selected-hover-bg, #bae0ff);
  }
`
...
const ResizeHandle = styled.div`
  ...
  cursor: col-resize;
  background: var(--rules-layout-bg, whitesmoke);
  ...
  &:before {
    ...
    margin: 0 auto;
    border-radius: 999px;
    background: var(--rules-border-color, #d9d9d9);
  }
...
const DetailPane = styled.aside`
  ...
  min-width: 0;
  overflow: auto;
  border-left: 1px solid var(--rules-border-secondary-color, #f0f0f0);
