...
import { TAddressGroupResource } from '../AddressGroupsPage/tableConfig'
import {
  ...
  TServiceResource,
} from '../AddressGroupsPage/contentsTree'
import { formatDateTime, formatMapEntries, THostResource } from '../HostsPage/tableConfig'
      ...
      <Styled.CustomCard>
        <Styled.TitleAndControlsRow ref={titleRef}>
          <Styled.TitleAndExpandCollapse>
            ...
            <Styled.Title>{rule.metadata.name || 'Rule'}</Styled.Title>
          </Styled.TitleAndExpandCollapse>
          <div>
        ...
        <Styled.OverflowContainer $height={height}>
          ...
          <Styled.SubtitleWithIcon>
            ...
            <Styled.Subtitle>Source</Styled.Subtitle>
          </Styled.SubtitleWithIcon>
          {isContentsLoading ? (
            <Spin />
          ) : (
          ...
          <Styled.SubtitleWithIcon>
            ...
            <Styled.Subtitle>Destination</Styled.Subtitle>
          </Styled.SubtitleWithIcon>
          {isContentsLoading ? (
            <Spin />
          ) : (
